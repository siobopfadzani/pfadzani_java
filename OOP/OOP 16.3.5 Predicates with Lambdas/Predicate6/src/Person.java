...
public class Person
{
    ...
    public static  void main(String[]args)
    {
        ...
        Stream<Person> checkAge = persons.stream().filter(a -> a.getAge() > 50);

        // Now iterate over the filtered stream
        checkAge.forEach(person -> System.out.println("name : " + person.getName()+ " surname " + person.getSurname() + " age " + person.getAge()+" gender " + person.getGender()+" city "+ person.getCity()));
